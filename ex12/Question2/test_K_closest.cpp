...
int main()
{
    ...
    Point p6(12.0, 3.0, 11.0);
    std::cout << "p6: (" << p6.x << ", " << p6.y << ", " << p6.z << ")" << std::endl;
    Point p7(8.0, 12.0, 3.0);
    ...
    std::cout << std::endl;
    std::cout << "k = " << ls_2.size() << std::endl;
    for (int i = 0; i < k_2; i++)
    {
        std::cout << "(" << ls_2.front().x << ", " << ls_2.front().y << ", " << ls_2.front().z << ") : distance = ";
        std::cout << std::sqrt((ls_2.front().x * ls_2.front().x) + (ls_2.front().y * ls_2.front().y) + (ls_2.front().z * ls_2.front().z)) << std::endl;
        ls_2.pop_front();
    }
    std::cout << "-----------------------------" << std::endl;
